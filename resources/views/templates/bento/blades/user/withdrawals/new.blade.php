...
@section('content')
    ...
    <div class="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-accent-primary/5">
    <div class="w-full max-w-md rounded-[32px] border border-white/10 shadow-2xl relative overflow-hidden bg-accent-primary/5">
        <!-- Header Decor -->
        ...
        <div class="p-8">
            ...
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 rounded-2xl bg-red-500/20 border border-red-500/30 flex items-center justify-center">
            ...
            <div class="text-center space-y-4">
                ...
                <p class="text-gray-300 text-base font-semibold leading-relaxed">
            ...
            <div class="mt-8">
                <a href="{{ route('user.contact') }}"
                    class="w-full flex items-center justify-center gap-3 py-4 bg-accent-primary hover:bg-accent-primary-hover text-white text-base font-extrabold rounded-xl transition-all shadow-lg active:scale-[0.98]">
